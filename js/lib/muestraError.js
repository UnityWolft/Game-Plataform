...
/**
 * Muestra los datos de un error en la consola y en un cuadro de alerta.
 * @param {ProblemDetailsError | Error | null} error
 */
export function muestraError(error) {
  if (error === null) {
    ...
    if (mensaje === "") {
      mensaje = "Error en el sistema de calificaciones"
    }
